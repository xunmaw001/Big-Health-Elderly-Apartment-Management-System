...
public class LaorenController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		LaorenEntity user = laorenService.selectOne(new EntityWrapper<LaorenEntity>().eq("xingming", username));
    ...
    public R register(@RequestBody LaorenEntity laoren){
    	...
    	LaorenEntity user = laorenService.selectOne(new EntityWrapper<LaorenEntity>().eq("xingming", laoren.getXingming()));
		if(user!=null) {

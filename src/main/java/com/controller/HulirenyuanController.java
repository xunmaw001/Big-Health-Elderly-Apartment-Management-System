...
public class HulirenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HulirenyuanEntity user = hulirenyuanService.selectOne(new EntityWrapper<HulirenyuanEntity>().eq("hulizhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"hulirenyuan",  "护理人员" );
    ...
    public R register(@RequestBody HulirenyuanEntity hulirenyuan){
    	...
    	HulirenyuanEntity user = hulirenyuanService.selectOne(new EntityWrapper<HulirenyuanEntity>().eq("hulizhanghao", hulirenyuan.getHulizhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        HulirenyuanEntity user = hulirenyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
    	...
    	user.setMima("123456");
        hulirenyuanService.updateById(user);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<HulirenyuanEntity> wrapper = new EntityWrapper<HulirenyuanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = hulirenyuanService.selectCount(wrapper);

...
public class ChuangweixinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		chuangweixinxi.setClicknum(chuangweixinxi.getClicknum()+1);
		chuangweixinxi.setClicktime(new Date());
		chuangweixinxiService.updateById(chuangweixinxi);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ChuangweixinxiEntity chuangweixinxi, HttpServletRequest request,String pre){
        EntityWrapper<ChuangweixinxiEntity> ew = new EntityWrapper<ChuangweixinxiEntity>();

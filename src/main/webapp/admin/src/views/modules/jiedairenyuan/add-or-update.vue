<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接待账号" prop="jiedaizhanghao">
          <el-input v-model="ruleForm.jiedaizhanghao" 
              placeholder="接待账号" clearable  :readonly="ro.jiedaizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接待账号" prop="jiedaizhanghao">
              <el-input v-model="ruleForm.jiedaizhanghao" 
                placeholder="接待账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接待姓名" prop="jiedaixingming">
          <el-input v-model="ruleForm.jiedaixingming" 
              placeholder="接待姓名" clearable  :readonly="ro.jiedaixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接待姓名" prop="jiedaixingming">
              <el-input v-model="ruleForm.jiedaixingming" 
                placeholder="接待姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="入职日期" prop="ruzhiriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ruzhiriqi" label="入职日期" prop="ruzhiriqi">
              <el-input v-model="ruleForm.ruzhiriqi" 
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	jiedaizhanghao : false,
	mima : false,
	jiedaixingming : false,
	nianling : false,
	xingbie : false,
	lianxidianhua : false,
	zhaopian : false,
	ruzhiriqi : false,
      ...
      rules: {
          jiedaizhanghao: [
                { required: true, message: '接待账号不能为空', trigger: 'blur' },
          ],
          mima: [
                { required: true, message: '密码不能为空', trigger: 'blur' },
          ],
          jiedaixingming: [
                { required: true, message: '接待姓名不能为空', trigger: 'blur' },
          ],
          nianling: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiedaizhanghao'){
            this.ruleForm.jiedaizhanghao = obj[o];
	    this.ro.jiedaizhanghao = true;
            continue;
          }
          if(o=='mima'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='jiedaixingming'){
            this.ruleForm.jiedaixingming = obj[o];
	    this.ro.jiedaixingming = true;
            continue;
          }
          if(o=='nianling'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiedairenyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiedairenyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();

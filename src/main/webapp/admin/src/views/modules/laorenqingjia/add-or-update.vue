  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qishishijian" label="起始时间" prop="qishishijian">
              <el-input v-model="ruleForm.qishishijian" 
                placeholder="起始时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否销假" prop="shifouxiaojia">
          <el-select :disabled="ro.shifouxiaojia" v-model="ruleForm.shifouxiaojia" placeholder="请选择是否销假">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="是否销假" prop="shifouxiaojia">
	      <el-input v-model="ruleForm.shifouxiaojia"
                placeholder="是否销假" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qingjiayuanyin" label="请假原因" prop="qingjiayuanyin">
                    <span>{{ruleForm.qingjiayuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.qishishijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qingjiatianshu = true;
          ...
          if(o=='shifouxiaojia'){
            this.ruleForm.shifouxiaojia = obj[o];
	    this.ro.shifouxiaojia = true;
            continue;
          }
          if(o=='qingjiayuanyin'){

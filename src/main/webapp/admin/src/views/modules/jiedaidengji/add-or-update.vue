<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="登记编号" prop="dengjibianhao">
            <el-input v-model="ruleForm.dengjibianhao" 
                placeholder="登记编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dengjibianhao" label="登记编号" prop="dengjibianhao">
              <el-input v-model="ruleForm.dengjibianhao" 
                placeholder="登记编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="接待时间" prop="jiedaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jiedaishijian" 
                type="datetime"
                :readonly="ro.jiedaishijian"
                placeholder="接待时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiedaishijian" label="接待时间" prop="jiedaishijian">
              <el-input v-model="ruleForm.jiedaishijian" 
                placeholder="接待时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="接待情况" prop="jiedaiqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="接待情况"
                  v-model="ruleForm.jiedaiqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiedaiqingkuang" label="接待情况" prop="jiedaiqingkuang">
                    <span>{{ruleForm.jiedaiqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.jiedaishijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nianling = true;
          ...
          if(o=='jiedaishijian'){
            this.ruleForm.jiedaishijian = obj[o];
	    this.ro.jiedaishijian = true;
            continue;
          }
          if(o=='jiedaiqingkuang'){
            this.ruleForm.jiedaiqingkuang = obj[o];
	    this.ro.jiedaiqingkuang = true;
            continue;
          }
          if(o=='userid'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiedaidengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiedaidengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();

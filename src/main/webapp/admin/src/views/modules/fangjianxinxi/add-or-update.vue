<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.fangjiantupian" label="房间图片" prop="fangjiantupian">
          <file-upload
          tip="点击上传房间图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fangjiantupian" label="房间图片" prop="fangjiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fangjiantupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="房间状态" prop="fangjianzhuangtai">
          <el-select :disabled="ro.fangjianzhuangtai" v-model="ruleForm.fangjianzhuangtai" placeholder="请选择房间状态">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="空闲床位" prop="kongxianchuangwei">
          <el-input v-model="ruleForm.kongxianchuangwei" 
              placeholder="空闲床位" clearable  :readonly="ro.kongxianchuangwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="空闲床位" prop="kongxianchuangwei">
              <el-input v-model="ruleForm.kongxianchuangwei" 
                placeholder="空闲床位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房间环境" prop="fangjianhuanjing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="房间环境"
                  v-model="ruleForm.fangjianhuanjing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangjianhuanjing" label="房间环境" prop="fangjianhuanjing">
                    <span>{{ruleForm.fangjianhuanjing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="房间介绍" prop="fangjianjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fangjianjieshao" label="房间介绍" prop="fangjianjieshao">
                    <span v-html="ruleForm.fangjianjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	kongxianchuangwei : false,
	fangjianhuanjing : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangjianzhuangtai = true;
          ...
          if(o=='kongxianchuangwei'){
            this.ruleForm.kongxianchuangwei = obj[o];
	    this.ro.kongxianchuangwei = true;
            continue;
          }
          if(o=='fangjianhuanjing'){
            this.ruleForm.fangjianhuanjing = obj[o];
	    this.ro.fangjianhuanjing = true;
            continue;
          }
	...
	this.ruleForm.fangjianjieshao = this.ruleForm.fangjianjieshao.replace(reg,'../../../ssm05293/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

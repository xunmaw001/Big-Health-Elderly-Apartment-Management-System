  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.quxiaoshijian" label="取消时间" prop="quxiaoshijian">
              <el-input v-model="ruleForm.quxiaoshijian" 
                placeholder="取消时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="取消原因" prop="quxiaoyuanyin">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.quxiaoyuanyin" label="取消原因" prop="quxiaoyuanyin">
                    <span>{{ruleForm.quxiaoyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>

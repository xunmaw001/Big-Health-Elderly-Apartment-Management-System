<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="护理等级" prop="hulidengji">
          <el-select :disabled="ro.hulidengji" v-model="ruleForm.hulidengji" placeholder="请选择护理等级">
            <el-option
                v-for="(item,index) in hulidengjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="护理等级" prop="hulidengji">
	      <el-input v-model="ruleForm.hulidengji"
                placeholder="护理等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="护理时间" prop="hulishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.hulishijian" 
                type="datetime"
                :readonly="ro.hulishijian"
                placeholder="护理时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.hulishijian" label="护理时间" prop="hulishijian">
              <el-input v-model="ruleForm.hulishijian" 
                placeholder="护理时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护理账号" prop="hulizhanghao">
          <el-input v-model="ruleForm.hulizhanghao" 
              placeholder="护理账号" clearable  :readonly="ro.hulizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护理账号" prop="hulizhanghao">
              <el-input v-model="ruleForm.hulizhanghao" 
                placeholder="护理账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护理姓名" prop="hulixingming">
          <el-input v-model="ruleForm.hulixingming" 
              placeholder="护理姓名" clearable  :readonly="ro.hulixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护理姓名" prop="hulixingming">
              <el-input v-model="ruleForm.hulixingming" 
                placeholder="护理姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="护理内容" prop="hulineirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.hulineirong" label="护理内容" prop="hulineirong">
                    <span v-html="ruleForm.hulineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.hulishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='hulidengji'){
            this.ruleForm.hulidengji = obj[o];
	    this.ro.hulidengji = true;
            continue;
          }
          if(o=='hulineirong'){
	    ...
	    this.ro.hulineirong = true;
          ...
          if(o=='hulishijian'){
            this.ruleForm.hulishijian = obj[o];
	    this.ro.hulishijian = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.hulizhanghao!=''&&json.hulizhanghao){
                this.ruleForm.hulizhanghao = json.hulizhanghao
	    		this.ro.hulizhanghao = true;
		}
		if(json.hulixingming!=''&&json.hulixingming){
          ...
          this.$message.error(data.msg);
            ...
            this.hulidengjiOptions = "特级护理,一级护理,二级护理,三级护理".split(',')
    },
    // 下二随
    xingmingChange () {
      this.$http({
	...
	this.ruleForm.hulineirong = this.ruleForm.hulineirong.replace(reg,'../../../ssm05293/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `hulijilu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.hulijiluCrossAddOrUpdateFlag = false;
						 this.parent.search();

<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="提醒编号" prop="tixingbianhao">
            <el-input v-model="ruleForm.tixingbianhao" 
                placeholder="提醒编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tixingbianhao" label="提醒编号" prop="tixingbianhao">
              <el-input v-model="ruleForm.tixingbianhao" 
                placeholder="提醒编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="提醒时间" prop="tixingshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tixingshijian" label="提醒时间" prop="tixingshijian">
              <el-input v-model="ruleForm.tixingshijian" 
                placeholder="提醒时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="提醒内容" prop="tixingneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tixingneirong" label="提醒内容" prop="tixingneirong">
                    <span>{{ruleForm.tixingneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='tixingbianhao'){
            this.ruleForm.tixingbianhao = obj[o];
	    this.ro.tixingbianhao = true;
            continue;
          }
          if(o=='xingming'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shengritixing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shengritixingCrossAddOrUpdateFlag = false;
						 this.parent.search();

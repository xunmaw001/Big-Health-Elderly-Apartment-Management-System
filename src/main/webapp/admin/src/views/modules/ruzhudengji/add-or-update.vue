<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="房间号" prop="fangjianhao">
          <el-select :disabled="ro.fangjianhao" @change="fangjianhaoChange" v-model="ruleForm.fangjianhao" placeholder="请选择房间号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.fangjianhao" label="房间号" prop="fangjianhao">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="入住状态" prop="ruzhuzhuangtai">
        ...
        <div v-else>
          <el-form-item class="input" label="入住状态" prop="ruzhuzhuangtai">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="护理账号" prop="hulizhanghao">
          <el-select :disabled="ro.hulizhanghao" @change="hulizhanghaoChange" v-model="ruleForm.hulizhanghao" placeholder="请选择护理账号">
            <el-option
                v-for="(item,index) in hulizhanghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.hulizhanghao" label="护理账号" prop="hulizhanghao">
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/hulirenyuan/hulizhanghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.hulizhanghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    fangjianhaoChange () {
      this.$http({
        url: `follow/chuangweixinxi/fangjianhao?columnValue=`+ this.ruleForm.fangjianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              ...
              if(data.data.hulixingming){
                this.ruleForm.hulixingming = data.data.hulixingming
              }
        } else {
          this.$message.error(data.msg);
        }
    ...
    hulizhanghaoChange () {
      this.$http({
        url: `follow/hulirenyuan/hulizhanghao?columnValue=`+ this.ruleForm.hulizhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.chuangweihao){

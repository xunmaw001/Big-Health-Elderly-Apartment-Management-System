    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="房间号" prop="fangjianhao">
          <el-select :disabled="ro.fangjianhao" v-model="ruleForm.fangjianhao" placeholder="请选择房间号">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="位置" prop="weizhi">
          <el-input v-model="ruleForm.weizhi" 
              placeholder="位置" clearable  :readonly="ro.weizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="位置" prop="weizhi">
              <el-input v-model="ruleForm.weizhi" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="床位状态" prop="chuangweizhuangtai">
          <el-select :disabled="ro.chuangweizhuangtai" v-model="ruleForm.chuangweizhuangtai" placeholder="请选择床位状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="床位状态" prop="chuangweizhuangtai">
	      <el-input v-model="ruleForm.chuangweizhuangtai"
                placeholder="床位状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangxijieshao" label="详细介绍" prop="xiangxijieshao">
                    <span v-html="ruleForm.xiangxijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weizhi = true;
          ...
          if(o=='chuangweizhuangtai'){
            this.ruleForm.chuangweizhuangtai = obj[o];
	    this.ro.chuangweizhuangtai = true;
            continue;
          }
          if(o=='xiangxijieshao'){
	...
	this.ruleForm.xiangxijieshao = this.ruleForm.xiangxijieshao.replace(reg,'../../../ssm05293/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chuangweixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chuangweixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
